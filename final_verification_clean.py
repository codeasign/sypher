...
def main():
    ...
    print("PASSED: Two Sum tests passed!")

    print("\nTesting Max Profit (Buy and Sell Stock)...")
    assert max_profit([7, 1, 5, 3, 6, 4]) == 5
    assert max_profit([7, 6, 4, 3, 1]) == 0
    assert max_profit([1, 2, 3, 4, 5]) == 4
    print("PASSED: Max Profit tests passed!")
    ...
    print("PASSED: Reverse Linked List tests passed!")

    print("\nTesting Product of Array Except Self...")
    assert product_except_self([1, 2, 3, 4]) == [24, 12, 8, 6]
    assert product_except_self([-1, 1, 0, -3, 3]) == [0, 0, 9, 0, 0]
    assert product_except_self([2, 3, 4, 5]) == [60, 40, 30, 24]
    print("PASSED: Product of Array Except Self tests passed!")
    ...
    print("PASSED: Remove Duplicates tests passed!")
    ...
    print("PASSED: Coin Change tests passed!")

    print("\n" + "="*60)
    print("SUCCESS: All coding bootcamp problems verified!")
    print("PASSED: Examples work correctly")
    print("PASSED: All test cases pass")
    print("PASSED: All solutions are correct")
    print("PASSED: Students can successfully complete all coding exercises")
    print("="*60)
