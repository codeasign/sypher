...
This course covers all 23 Gang-of-Four design patterns, organized by creational, structural, and behavioral categories. Each pattern has a theory page with pseudocode and a domain example, plus a complete, runnable implementation in six languages.
...
- Familiarity with the SOLID principles is helpful but not required
...
Each pattern has multiple language-specific implementations so you can follow along in your preferred language or compare across languages. Start with the theory page for each pattern, then dive into the language-specific pages that interest you.
