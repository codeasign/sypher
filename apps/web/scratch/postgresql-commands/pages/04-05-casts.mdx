...
| number_from_text | date_from_text | text_from_number |
|---:|---|---|
| 1234.50 | 2007-03-15 | 1,234.50 |
...
```text
ERROR:  invalid input syntax for type integer: "12abc"
LINE 1: SELECT '12abc'::integer;
               ^
```
