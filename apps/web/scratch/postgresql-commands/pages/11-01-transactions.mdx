...
| table_after_rollback | nickname_column |
|---|---:|
| NULL | 0 |
...
Create and fill the table first, then BEGIN; DELETE; ROLLBACK; then COUNT.
...
Two UPDATEs between BEGIN and COMMIT.
...
SAVEPOINT after the first UPDATE; ROLLBACK TO SAVEPOINT before COMMIT.
