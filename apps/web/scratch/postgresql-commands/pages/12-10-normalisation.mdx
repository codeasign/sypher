...
| order_id | customer_name | customer_city | product_id | product_name | unit_price | qty |
|---:|---|---|---:|---|---:|---:|
| 1 | Asha | Pune | 10 | Notebook | 4.50 | 2 |
| 1 | Asha | Pune | 20 | Stapler | 12.00 | 1 |
| 2 | Asha | Pune | 10 | Notebook | 4.50 | 5 |
...
| tags | as_array | one_per_row |
|---|---|---|
| paper,office | {paper,office} | paper |
| paper,office | {paper,office} | office |
...
| order_id | customer | product | unit_price | qty |
|---:|---|---|---:|---:|
| 1 | Asha | Notebook | 4.50 | 2 |
| 1 | Asha | Stapler | 12.00 | 1 |
| 2 | Asha | Notebook | 4.50 | 5 |
| 3 | Ben | Notebook | 4.50 | 1 |
...
Create the flat table, update one row, then `COUNT(DISTINCT customer_city)`.
...
`CREATE TABLE customer_split AS SELECT DISTINCT customer_name, customer_city FROM ...`.
...
`SELECT product_id, unnest(string_to_array(tags, ',')) AS tag FROM ...`.
