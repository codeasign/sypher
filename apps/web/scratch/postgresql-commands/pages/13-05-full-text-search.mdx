...
| to_tsvector |
|---|
| 'away':7 'brown':3 'fox':4 'quick':2 'run':6 |
...
| title | fulltext |
|---|---|
| ACADEMY DINOSAUR | 'academi':1 'battl':15 'canadian':20 'dinosaur':2 'drama':5 'epic':4 'feminist':8 'mad':11 'must':14 'rocki':21 'scientist':12 'teacher':17 |
...
| title | rank |
|---|---:|
| ACADEMY DINOSAUR | 0.0991 |
| BANG KWAI | 0.0991 |
| GROSSE WONDERFUL | 0.0991 |
...
| excerpt |
|---|
| Drama of a Feminist And a Mad [Scientist] who must Battle a Teacher in The Canadian Rockies |
...
`WHERE fulltext @@ to_tsquery('english', 'crocodile')`.
...
`to_tsquery('english', 'shark & crocodile')`.
