...
|---|---:|---:|
| 2006-11 | 59.84 | 87.80 |
| 2006-12 | 1237.96 | 1187.28 |
| 2007-01 | 3657.43 | 3542.50 |
| 2007-02 | 6330.54 | 6536.29 |
...
| 2005-05 | store_1 | 575 |
| 2005-05 | store_2 | 581 |
| 2005-06 | store_1 | 1121 |
| 2005-06 | store_2 | 1190 |
...
`COUNT(*) FILTER (WHERE rating = 'G')` and so on.
...
`COUNT(*) FILTER (WHERE EXTRACT(isodow FROM lower(rental_period)) = 1) AS mon`, and so on.
...
Join inventory -> film_category -> category, `COUNT(*) FILTER (WHERE i.store_id = 1)`.
