import {
  ...
  courseTestAutomation, courseDefects, courseDefectLeakage, courseTestStability, courseQualityTrends,
...
async function main() {
  const courses = [courseTestAutomation(), courseDefects(), courseDefectLeakage(), courseTestStability(), courseQualityTrends()];
  const results = [];
