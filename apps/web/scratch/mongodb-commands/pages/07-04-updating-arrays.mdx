...
[ { sku: 'pen', qty: 107 }, { sku: 'pad', qty: 103 } ]
```
...
[ [ 'pen:low stock', 'ink:-', 'pad:low stock' ], [ 'pen:-', 'pad:-' ] ]
```
...
```text
[ { qty: 1 }, { qty: 2, flag: true }, { qty: 3, flag: true } ]
```

<details>
<summary>Hint</summary>

`$[big]` and `arrayFilters: [{ "big.qty": { $gt: 1 } }]`.
