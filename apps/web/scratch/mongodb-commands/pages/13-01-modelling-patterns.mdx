...
[
  {
    ...
    rentalId: 76,
    filmId: 663,
    film: { title: 'PATIENT SISTER', rating: 'NC-17' }
  },
  {
    customerId: 1,
    rentalId: 573,
    filmId: 875,
    film: { title: 'TALENTED HOMICIDE', rating: 'PG' }
  },
  {
    customerId: 1,
    rentalId: 1185,
    filmId: 611,
    film: { title: 'MUSKETEERS WAIT', rating: 'PG' }
  }
]
```
...
```text
[
  { _id: 1, rentalCount: 32, totalPaid: 118.68 },
  { _id: 2, rentalCount: 27, totalPaid: 128.73 },
  { _id: 3, rentalCount: 26, totalPaid: 135.74 }
]
```
...
[
  {
    _id: { sensor: 's1', hour: ISODate('2026-01-01T10:00:00.000Z') },
    values: [ 20, 21 ],
    n: 2,
    avg: 20.5
  },
  {
    _id: { sensor: 's1', hour: ISODate('2026-01-01T11:00:00.000Z') },
    values: [ 22 ],
    n: 1,
    avg: 22
  }
...
```text
[ { rentalCount: 32, totalPaid: 118.68 } ]
```
...
`$dateTrunc` with `unit: "day"`, then `$group` and count.
