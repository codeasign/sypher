...
```text
{ returned: 25, keys: 0, docs: 10000, sort: true }
```
...
```text
{ returned: 25, keys: 25, docs: 25, sort: false }
```
...
```text
{ returned: 495, keys: 556, docs: 495, sort: false }
```
...
```text
{ returned: 4980, keys: 4980, docs: 4980, sort: false }
```
...
```text
{ returned: 25, keys: 25, docs: 0, sort: false }
```
...
```text
[
  { returned: 1, keys: 1, docs: 1, sort: false },
  { returned: 1, keys: 10000, docs: 1, sort: false }
]
```
...
A compound index on `customer` and `status`.
...
Equality on `customer`, then the sort field `day`.
