...
```text
MongoServerError: E11000 duplicate key error collection: lab_special.users index: email_1 dup key: { email: "ann@x.com" }
```
...
```text
MongoServerError: E11000 duplicate key error collection: lab_special.enrol index: student_1_course_1 dup key: { student: "a", course: "x" }
```
...
```text
MongoServerError: E11000 duplicate key error collection: lab_special.tags index: code_1 dup key: { code: null }
```
...
```text
MongoServerError: E11000 duplicate key error collection: lab_special.people index: email_1 collation: { locale: "en", caseLevel: false, caseFirst: "off", strength: 2, numericOrdering: false, alternate: "non-ignorable", maxVariable: "punct", normalization: false, backwards: false, version: "57.1" } dup key: { email: "CollationKey(0x2943430a7a57082d4541010d)" }
```
...
The duplicate key error code is 11000.
