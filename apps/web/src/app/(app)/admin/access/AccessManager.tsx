...
// Material Symbols "info" glyph, inlined — apps/web has no MUI/icon-font
// dependency (deliberately, see BlogPostPage/CodeBlock's own inline-SVG
// icons), so this is the actual Material Design path data self-contained
// rather than pulling in @mui/icons-material for one icon.
