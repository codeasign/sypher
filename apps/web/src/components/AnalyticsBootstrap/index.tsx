...
// no cookie at all. This cookie is shared across next.sypher.local and
// corporate.sypher.local (same cookie domain as the auth session), so a
// choice made on one host is respected on the other. wait_for_update gives
