...
// corporate.sypher.local (see @sypher/auth-core/src/analyticsConsent.js),
// so a choice made here isn't re-asked over there and vice versa. Essential
// cookies (the auth session, this consent cookie itself) aren't a real
// toggle -- they're strictly necessary and have no corresponding Consent
// Mode signal to gate, so they're shown as always-on rather than persisted
// as a choice.
