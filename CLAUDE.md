...
- playwright-mastery — Playwright Mastery (full end-to-end course: why-playwright, setup, typescript-basics, page-object-model, locators, actions, assertions, waiting, api-testing, self-healing-locators, visual-testing, trace-viewer, parallel-execution, authentication, github-actions, docker, reporting, playwright-mcp-server, playwright-cli-agent, ai-test-generation; practice section with beginner/intermediate/advanced/solutions; 160 interview questions)
